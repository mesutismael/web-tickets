...
import be.appreciate.webtickets.fragments.EventDetailFragment;
...
public class EventDetailActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        this.setContentView(R.layout.activity_event_detail);
        ...
        this.getSupportFragmentManager()
                .beginTransaction()
                .replace(R.id.frameLayout_content, EventDetailFragment.newInstance(eventId))
                .commit();
    }
}
